...
async def create_template(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Failed to create training template"
        )
...
async def update_template(
    ...
    try:
        ...
        # An explicit null for a NOT NULL column: invalid input, not a server fault
        # (review R2F-10). It used to reach the database and surface as a 500.
