          ...
          <div>
            ...
            <div className="space-y-2">
              {intervals.map((interval) => (
                <label
                  key={interval.value}
                  className="flex items-center gap-3 p-3 rounded-lg border border-slate-300 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 cursor-pointer transition-colors"
                >
                  <input
                    type="radio"
                    name="interval"
                  ...
                  />
                  <span className="text-sm text-slate-800 dark:text-slate-200">{interval.label}</span>
                </label>
              ))}
            </div>
          </div>
