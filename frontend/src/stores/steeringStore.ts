...
interface SteeringState {
  ...
  /**
   * The card steering generations run on: `"auto"` or a GPU UUID. Sent on every
   * compare, sweep and combined request. Session-only — a saved UUID names a
   * card that may since have been removed.
   */
  gpu: string;
