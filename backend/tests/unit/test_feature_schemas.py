...
class TestFeatureStatistics:
    ...
    def test_makes_no_interpretability_claim(self):
        """`interpretable_percentage` was the share of features whose
        activation-consistency score exceeded 0.5 — a shape metric that pays
        most for single-token evidence. It is not reported as interpretability.
        """
