...
| `trainings/{id}/progress` | `training:progress`, `training:completed`, `training:failed`, `training:status_changed`, `training:evaluation` | SAE training (includes live loss/L0/dead-neuron metrics) |
