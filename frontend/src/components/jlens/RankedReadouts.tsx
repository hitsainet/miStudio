                ...
                <button
                  ...
                  title={
                    ...
                    (partner
                      ...
                      : // NO PIN REQUIRED ANY MORE. The partner is typed in the
                        // composer this opens; telling the reader to pin one
                        // sends them to satisfy a prerequisite that no longer
                        // exists, and pinning does not enable anything here.
                        `Swap ${displayToken(r.token)} — choose what to exchange it with`)
                  }
