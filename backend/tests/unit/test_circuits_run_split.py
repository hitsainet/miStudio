...
def _rows(*, layers=(1, 2), params=1_000_000_000, sae_dims=(4096, 16_384)):
    ...
    # hook_type=None, as the nullable ExternalSAE column always has: capture refuses a
    # non-residual SAE before it loads the model (review R2-B) and reads it.
    saes = {f"sae_l{L}": SimpleNamespace(id=f"sae_l{L}", layer=L, model_id="m_1", hook_type=None,
