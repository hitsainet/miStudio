...
| `MCP_TOOL_CATEGORIES` | `read,groups,steering,labeling,experiments,profiles,circuits,jlens,jobs,models` | Which tool categories are exposed; add `admin` to enable destructive deletes |
