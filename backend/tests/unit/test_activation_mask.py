...
class TestTheSharedPaddedBatchBuilder:
    ...
    def test_both_extraction_paths_call_it(self):
        ...
        first's defect. The on-the-fly training path builds its batches in
        `model_activation_source` since remediation item 3 (2026-09-15)."""
        import ast
        import inspect

        from src.services import activation_service, model_activation_source

        for module in (activation_service, model_activation_source):
