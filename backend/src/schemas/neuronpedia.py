...
#: The logit lens is the only GPU work behind these requests.
LOGIT_LENS_GPU_DESCRIPTION = (
    GPU_REQUEST_DESCRIPTION + " Used for the logit lens, the only part of this work that runs on a GPU."
)
...
class NeuronpediaExportRequest(BaseModel):
    ...
    gpu: GpuRequestStr = Field(AUTO, description=LOGIT_LENS_GPU_DESCRIPTION)
