...
from src.workers.gpu_job import gpu_job
...
# In place: only a LOCAL judge uses a GPU, placed after the examples are gathered.
@gpu_job("labeling", handoff=False)
...
@gpu_job("labeling_sweep", handoff=False)
