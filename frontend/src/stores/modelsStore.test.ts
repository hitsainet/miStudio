...
describe('modelsStore', () => {
  ...
  describe('downloadModel', () => {
    it('should download model successfully', async () => {
      ...
      await downloadModel('gpt2', QuantizationFormat.Q8, undefined, undefined, 'auto');
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          body: JSON.stringify({
            ...
            // Quantized loading runs on a card; the choice travels with the download.
            gpu: 'auto',
          }),
        })
      );
    ...
    it('should download model with access token', async () => {
      ...
      const { downloadModel } = useModelsStore.getState();
      await downloadModel('org/gated-model', QuantizationFormat.Q4, 'test_token_123', undefined, 'GPU-247aa582-0d1b-e161-8156-983ed1fefc57');
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          body: JSON.stringify({
            ...
            quantization: 'Q4',
            trust_remote_code: false,
            gpu: 'GPU-247aa582-0d1b-e161-8156-983ed1fefc57',
    ...
    it('should handle download error', async () => {
      ...
      await expect(downloadModel('invalid/repo', QuantizationFormat.Q4, undefined, undefined, 'auto')).rejects.toThrow(
        'Invalid repo_id'
      );
  ...
  describe('WebSocket subscription callback', () => {
    it('should register subscription callback', async () => {
      ...
      const { downloadModel } = useModelsStore.getState();
      await downloadModel('gpt2', QuantizationFormat.Q4, undefined, undefined, 'auto');
