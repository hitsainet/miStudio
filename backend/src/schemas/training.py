...
class TrainingHyperparameters(BaseModel):
    ...
    holdout_fraction: float = Field(
        ...
        description=(
            ...
            "evaluation. 0 reproduces the historical behaviour, where every "
            "reported number is in-sample. Split by document, not token: "
            "adjacent positions are near-duplicates."
        ),
    )
