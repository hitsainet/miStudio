          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div>
              <p
                ...
                title="How similar this feature's activation shape is across its top examples. Not a measure of interpretability — it is highest for evidence that repeats a single token."
              >
                Activation consistency
              </p>
              <p className="text-xl font-semibold text-blue-400">
                {((selectedFeature.activation_consistency ?? selectedFeature.interpretability_score) * 100).toFixed(1)}%
              </p>
            </div>
            <div>
