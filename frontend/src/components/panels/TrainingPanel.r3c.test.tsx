...
const HP_OLDER = {
  ...
  ste_bandwidth: 0.5,
  normalize_decoder: true,
  // The template lacks it, so it takes the backend DEFAULT — which is now
  // sent, because an omitted value would be indistinguishable from an
  // explicit 0 that the backend must honour.
