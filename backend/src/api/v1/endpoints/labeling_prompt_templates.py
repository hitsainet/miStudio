...
async def update_template(
    ...
    """
    from ....services.template_updates import NullNotAllowed
    ...
    try:
        ...
        return template
    except NullNotAllowed as e:
        # BEFORE the ValueError branch below, which answers 403 "cannot modify a system
        # template" — a wrong explanation for a null field (review R2F-10). NullNotAllowed
        # derives from ValueError, so order matters here.
